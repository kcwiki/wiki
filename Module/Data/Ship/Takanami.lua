...
return {
    [""] = {
        ...
        _wikipedia = "Japanese destroyer Takanami (1942)",
    },
    ["Kai"] = {
        _name = "Takanami",
        _suffix = "Kai",
        ...
        _remodel_from = "Takanami/",
        _remodel_to = "Takanami/Kai Ni",
        _fuel = 15,
        _ammo = 20,
        _scrap_fuel = 1,
        _scrap_ammo = 2,
